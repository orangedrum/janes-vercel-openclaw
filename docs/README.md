...
4. **Environment Variables** — every variable the app reads and when each one matters
5. **Deployment Protection** — how Vercel Deployment Protection interacts with channel webhooks
6. **API Reference** — request and response shapes for the admin and automation surfaces
